    ...
    func getEvent(set: mockSet) -> Event {
        ...
        case .ces:
            ...
            event.exhibits.append(Exhibit(title: "MacBook Pro",
                                          ...
                                          thumbnail: UIImage(named: "ces_ex0")!, position: event.exhibits.count-1, category: "Notebooks"))
            event.exhibits.append(Exhibit(title: "Samsung 8K TV",
                                          ...
                                          thumbnail: UIImage(named: "ces_ex1")!, position: event.exhibits.count-1, category: "TVs"))
            event.exhibits.append(Exhibit(title: "DJI Phantom 4",
                                          ...
                                          thumbnail: UIImage(named: "ces_ex2")!, position: event.exhibits.count-1, category: "Drones"))
            return event
        case .flora:
        ...
        case .geneva:
            ...
            event.exhibits.append(Exhibit(title: "Tesla Model S",
                                          ...
                                          thumbnail: UIImage(named: "geneva_ex0")!, position: event.exhibits.count-1, category: "Electric"))
            event.exhibits.append(Exhibit(title: "Jaguar F-Pace",
                                          ...
                                          thumbnail: UIImage(named: "geneva_ex1")!, position: event.exhibits.count-1, category: "Gasoline"))
            event.exhibits.append(Exhibit(title: "Mazda 6",
                                          ...
                                          thumbnail: UIImage(named: "geneva_ex2")!, position: event.exhibits.count-1, category: "Gasoline"))
            return event
        case .tutan:
